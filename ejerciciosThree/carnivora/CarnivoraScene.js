...
import { Carnivora } from './Carnivora.js'
...
class CarnivoraScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.model = new Carnivora(this.gui, "Controles de la Carnivora");
    this.add (this.model);
  }
  ...
  createGround () {
    ...
    var geometryGround = new THREE.BoxGeometry (2.5,0.02,2.5);
...
$(function () {
  ...
  var scene = new CarnivoraScene("#WebGL-output");
