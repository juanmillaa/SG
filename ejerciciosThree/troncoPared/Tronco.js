...
class Tronco extends THREE.Object3D {
  ...
  static materialConTexturaPunta = new THREE.MeshStandardMaterial({
      ...
      roughnessMap: Tronco.loader.load("../texturas/TexturaPuntaTronco/RoughPunta.png"),
      displacementMap: Tronco.loader.load("../texturas/TexturaPuntaTronco/DisplacementPunta.png"),
      displacementScale: 0
  });
  constructor(gui, titleGui) {
    ...
    this.materialConTexturaBase = Tronco.materialConTexturaBase;
    this.materialConTexturaPunta = Tronco.materialConTexturaPunta;
  ...
  createBase(tama) {
    ...
    //   displacementScale: 0.05
    // });
    // const textura = new THREE.TextureLoader().load('tronco.jpg');

    // const materialConTextura = new THREE.MeshStandardMaterial({
    //   map: textura,

    //   // Color base ligeramente marrón (opcional si la textura ya lo tiene)
    //   color: 0x8B5A2B,

    //   // La madera no emite luz → quitar o casi eliminar
    //   emissive: 0x000000,
    //   emissiveIntensity: 0,

    //   // Propiedades físicas más realistas
    //   roughness: 0.9,   // madera = rugosa
    //   metalness: 0.0    // no es metal
    // });
  ...
  // En Tronco.js, modifica el método createGUI
  createGUI(gui, titleGui) {
    // Si no se pasa un objeto GUI, no hacemos nada
    if (!gui || !titleGui) return;
  ...
  createPunta(tama) {
    ...
    //   displacementScale: 0
    // });
    // const textura = new THREE.TextureLoader().load('troncoPunta.jpg');
    ...
    const cono_punta = new THREE.Mesh(geometriaPunta, this.materialConTexturaPunta);
